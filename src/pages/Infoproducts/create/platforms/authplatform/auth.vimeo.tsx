...
import { setVimeoUrl } from "services/vimeo.services";
    ...
    <VStack w="100%" h="100%" alignItems="center">
      <VStack h="100%" alignItems="center" justify="center">
        ...
        <Text.Medium fontSize="20px">
          A integração está sendo feita e a página será redirecionada
          automaticamente.
        </Text.Medium>
        <Text.Small fontSize="16px">Aguarde.</Text.Small>
      </VStack>
    </VStack>
  );
};

export default AuthVimeo;
